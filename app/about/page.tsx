    ...
    <div className="container mx-auto p-4">
      ...
      <section className="mt-10">
        ...
        <ul className="list-disc list-inside space-y-2 text-lg leading-relaxed">
          ...
          <li>
            💾 <strong>ระบบโชว์คะแนนสุงสุดและแนะนำให้ทำการ signin:</strong>หลังเล่นเสร็จจะมีการเปรียบเทียบคะแนนว่ามีการเปลี่ยนแปลงหรือไม และ หากยังไม่ล็อคอินจะมีแจ้งเตือน
          </li>
          <li>
      ...
      <section>
        <h2 className="text-2xl font-semibold my-4">เครื่องมือที่ใช้ในการสร้างเกม</h2>
        <div className="mb-4">
