...
export default function GoogleSignInButton() {
  ...
  return (
    <>
      <button type="button" onClick={handleGoogleSignIn} className="my-3 btn bg-white border border-primary w-72 hover:bg-green-300 flex items-center justify-center gap-2">
